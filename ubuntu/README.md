...
-	[`17.10`, `artful-20180524`, `artful` (*artful/Dockerfile*)](https://github.com/tianon/docker-brew-ubuntu-core/blob/f63d0629745365a22cc5cb19f0505aa77a98927d/artful/Dockerfile)
-	[`18.04`, `bionic-20180526`, `bionic`, `latest`, `rolling` (*bionic/Dockerfile*)](https://github.com/tianon/docker-brew-ubuntu-core/blob/f63d0629745365a22cc5cb19f0505aa77a98927d/bionic/Dockerfile)
-	[`18.10`, `cosmic-20180605`, `cosmic`, `devel` (*cosmic/Dockerfile*)](https://github.com/tianon/docker-brew-ubuntu-core/blob/f63d0629745365a22cc5cb19f0505aa77a98927d/cosmic/Dockerfile)
-	[`16.04`, `xenial-20180525`, `xenial` (*xenial/Dockerfile*)](https://github.com/tianon/docker-brew-ubuntu-core/blob/f63d0629745365a22cc5cb19f0505aa77a98927d/xenial/Dockerfile)
...
```console
$ docker run s390x/ubuntu:18.04 grep -v '^#' /etc/apt/sources.list
